  ...
  return (
    <main className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-20 p-8 md:p-24">
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-center mb-12 text-white">
          Sign-in to {config.appName}
        </h1>

        <div className="space-y-8 max-w-xl mx-auto backdrop-blur-sm bg-white/5 rounded-xl p-8 border border-white/10 shadow-xl">
          <button
            className="btn btn-block bg-white hover:bg-gray-100 text-gray-900"
